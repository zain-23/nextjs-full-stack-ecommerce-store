    ...
    <div className="bg-slate-50">
        ...
        <MaxWidthWrapper className="pb-24 pt-10 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 xl:pt-32 lg:pb-52">
          <div className="col-span-2 px-6 lg:px-0 lg:pt-4">
            <div className="relative mx-auto text-center lg:text-left flex flex-col items-center lg:items-start">
              ...
              <p className="mt-8 text-lg max-w-prose text-center lg:text-left text-balance md:text-wrap">
              ...
              <div className="mt-12 flex flex-col sm:flex-row items-center sm:items-start gap-5">
                <div className="flex -space-x-4">
                  <Image
                    ...
                    width={100}
                    height={100}
                    className="inline-block h-10 w-10 ring-2 ring-slate-100 rounded-full"
                    alt="users images"
                  />
                  <Image
                  ...
                  <Image
                    ...
                    width={100}
                    height={100}
                    className="inline-block object-cover h-10 w-10 ring-2 ring-slate-100 rounded-full"
                    alt="users images"
                  />
                </div>
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <menu className="mx-auto mt-12 max-w-prose sm:text-lg space-y-2 w-fit">
            <li className="w-fit">
